...
![Bukti Load Balancer Bekerja](Images/bukti_loadbalancer_berkerja.png)

### 2. Pengecekan URL Products
![Cek URL Products](Images/cek_url_products.png)

### 3. Tampilan Docker Desktop (Container Running)
![View Docker Desktop](Images/view_docker_desktop.png)